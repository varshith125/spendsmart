  ...
  return (
    <div className="bg-gradient-mesh min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="absolute -top-10 -left-10 w-40 h-40 bg-pink-600/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="relative z-10 w-full">
          ...
          <motion.div variants={item} className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-600 to-blue-600 flex items-center justify-center mx-auto mb-4 shadow-[0_0_30px_rgba(219,39,119,0.4)] animate-pulse-glow">
              <Wallet className="w-8 h-8 text-white relative z-10" />
            </div>
            <h1 className="font-heading text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 tracking-tight">SpendSmart</h1>
            <p className="text-slate-400 text-sm mt-2">Start your financial journey</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <motion.div variants={item} className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 transition-colors group-focus-within:text-violet-400" />
              <input
                type="text"
